      ...
      try:
                if antiSpam is True:
                 ...
                 #   if not punish_cd_bucket.update_rate_limit():
                      if data["punishment"] == "kick":
                        ...
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Nexus | Anti Spam")
                        hacker = discord.Embed(color=0x2f3136,description=f"<:Nexus_tick:1144687280540369018> | Successfully Muted {message.author} For Spamming")
                      ...
                      if data["punishment"] == "ban":
                        now = discord.utils.utcnow()
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Nexus | Anti Spam")
                        hacker1 = discord.Embed(color=0x2f3136,description=f"<:Nexus_tick:1144687280540369018> | Successfully Muted {message.author} For Spamming")
                      ...
                      if data["punishment"] == "none":
                        now = discord.utils.utcnow()
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Nexus | Anti Spam")
                        hacker2 = discord.Embed(color=0x2f3136,description=f"<:Nexus_tick:1144687280540369018> | Successfully Muted {message.author} For Spamming")
                ...
                if antiLink is True:
                    ...
                    if invite_matches:
                        ...
                        if data["punishment"] == "kick":
                            await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Nexus | Anti Discord Invites")
                            hacker3 = discord.Embed(color=0x2f3136,description=f"<:Nexus_tick:1144687280540369018> | Successfully Muted {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "ban":
                            await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Nexus | Anti Discord Invites")
                            hacker4 = discord.Embed(color=0x2f3136,description=f"<:Nexus_tick:1144687280540369018> | Successfully Muted {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "none":
                             now = discord.utils.utcnow()
                             await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Nexus | Anti Discord Invites")
                             hacker5 = discord.Embed(color=0x2f3136,description=f"<:Nexus_tick:1144687280540369018> | Successfully Muted {message.author} For Sending Discord Server Invites")
                    ...
                    if link_matches:
                        if data["punishment"] == "kick":
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Nexus | Anti Link")
                          hacker6 = discord.Embed(color=0x2f3136,description=f"<:Nexus_tick:1144687280540369018> | Successfully Muted {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "ban":
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Nexus | Anti Link")
                          hacker7 = discord.Embed(color=0x2f3136,description=f"<:Nexus_tick:1144687280540369018> | Successfully Muted {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "none":
                          now = discord.utils.utcnow()
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Nexus | Anti Link")
                          hacker8 = discord.Embed(color=0x2f3136,description=f"<:Nexus_tick:1144687280540369018> | Successfully Muted {message.author} For Sending Links")
