        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if streamables.search(thumbnail_link):
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:hacker_tick:1271209580793167925> | Successfully updated the boost thumbnail url .",
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if streamables.search(image_link):
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:hacker_tick:1271209580793167925> | Successfully updated the boost image url .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
    ...
    async def _boost_autodel(self, ctx, *, autodelete_second):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                color=0x2f3136,
                description=
                f"<:hacker_tick:1271209580793167925> | Successfully updated the boost autodelete second to {autodelete_second} .\nFrom now boost message will be deleted after {autodelete_second} .",
                timestamp=ctx.message.created_at)
            hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            await ctx.send(embed=hacker)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            try:
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:hacker_tick:1271209580793167925> | Successfully updated the boost message .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["boost"]["embed"] == True:
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:hacker_tick:1271209580793167925> | Okay, Now your embed is removed and boost message will be a plain message .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                hacker1 = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:hacker_tick:1271209580793167925> | Okay, Now your embed is enabled and boost message will be a embed message.",
                    timestamp=ctx.message.created_at)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["boost"]["ping"] == True:
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:hacker_tick:1271209580793167925> | Okay, Now your embed ping is disabled and users won't get pinged upon boost .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                hacker1 = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:hacker_tick:1271209580793167925> | Okay, Now your embed ping is enabled and I will ping new users outside the embed .",
                    timestamp=ctx.message.created_at)
                hacker1.set_author(name=f"{ctx.author.name}",
                                   icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker1)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(chh) == 1:
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:hacker_admin_cross:1271209737647558819> | You have reached maximum channel limit for channel which is one .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                if str(channel.id) in chh:
                    hacker1 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<:hacker_admin_cross:1271209737647558819> | This channel is already in the boost channels list .",
                        timestamp=ctx.message.created_at)
                    hacker1.set_author(name=f"{ctx.author.name}",
                                       icon_url=f"{ctx.author.avatar}")
                    await ctx.send(embed=hacker1)
                    ...
                    hacker4 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<:hacker_tick:1271209580793167925> | Successfully added {channel.mention} to boost channel list .",
                        timestamp=ctx.message.created_at)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(chh) == 0:
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:hacker_admin_cross:1271209737647558819> | This server dont have any boost channel setupped yet .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                if str(channel.id) not in chh:
                    hacker1 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<:hacker_admin_cross:1271209737647558819> | This channel is not in the boost channels list .",
                        timestamp=ctx.message.created_at)
                    hacker1.set_author(name=f"{ctx.author.name}",
                                       icon_url=f"{ctx.author.avatar}")
                    await ctx.send(embed=hacker1)
                    ...
                    hacker3 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<:hacker_tick:1271209580793167925> | Successfully removed {channel.mention} from boost channel list .",
                        timestamp=ctx.message.created_at)
    ...
    async def welctestt(self, ctx):
        ...
        if chan == []:
            hacker = discord.Embed(
                color=0x2f3136,
                description=
                f"<:hacker_admin_cross:1271209737647558819> | Oops, Kindly setup your boost channel first .",
                timestamp=ctx.message.created_at)
            hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            await ctx.send(embed=hacker)
    ...
    async def _reset(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["boost"]["channel"] == []:
                embed = discord.Embed(
                    description=
                    "<:hacker_admin_cross:1271209737647558819> | This server don't have any boost channel setuped yet .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                data["boost"]["channel"] = []
                ...
                hacker = discord.Embed(
                    description=
                    "<:hacker_tick:1271209580793167925> | Succesfully cleared all boost config for this server .",
                    color=0x2f3136)
                await ctx.send(embed=hacker)
        else:
    ...
    async def _boost1_role_reset(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if rl == []:
                embed = discord.Embed(
                    description=
                    "<:hacker_admin_cross:1271209737647558819> | This server don't have any boost role setupped .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                if rl != []:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:hacker_tick:1271209580793167925> | Succesfully cleared all boost role for {ctx.guild.name} .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
    ...
    async def _boost1_role_add(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(rl) == 5:
                embed = discord.Embed(
                    description=
                    f"<:hacker_admin_cross:1271209737647558819> | You have reached maximum channel limit for boost role which is five .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                if str(role.id) in rl:
                    embed1 = discord.Embed(
                        description=
                        "<:hacker_admin_cross:1271209737647558819> | {} is already in boost role ."
                        .format(role.mention),
                        color=0x2f3136)
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:hacker_tick:1271209580793167925> | {role.mention} has been added to boost role .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
    ...
    async def _boost1_role_remove(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(rl) == 0:
                embed = discord.Embed(
                    description=
                    f"<:hacker_admin_cross:1271209737647558819> | This server dont have any boost role setupped yet .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                if str(role.id) not in rl:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:hacker_tick:1271209580793167925> | {role.mention} has been removed from boost role .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
