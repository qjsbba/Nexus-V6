...
class HelpCommand(commands.HelpCommand):
    ...
    async def send_bot_help(self, mapping):
        ...
        embed = discord.Embed(description="Use the dropdown menu to select a category.", color=0x2f3136)
...
class Help(Cog, name="help"):
    def __init__(self, client: Astroz):
        ...
        # Initialize the custom HelpCommand without command_attrs
        help_command = HelpCommand()

        # Set the necessary attributes directly
        help_command.name = "help"
        help_command.aliases = ['h']
        help_command.cooldown = commands.CooldownMapping.from_cooldown(1, 5, commands.BucketType.user)
        help_command.help = 'Shows help about bot, a command, or a category'
