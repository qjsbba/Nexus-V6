...
class Verification(commands.Cog):
    ...
    async def verify_enable(self, ctx, channel: discord.TextChannel, role: discord.Role):
        try:
            ...
            if str(ctx.guild.id) in data:
                ...
                embed.set_footer(text="Server Verification", icon_url=ctx.guild.icon.url)
            ...
            print(f"Error in verify_enable: {e}")
    ...
    async def verify_disable(self, ctx):
        try:
            ...
            await ctx.send(f"Error during disable: {e}")
            print(f"Error in verify_disable: {e}")
    ...
    async def verify_config(self, ctx):
        try:
            ...
            await ctx.send(f"Error in config command: {e}")
            print(f"Error in verify_config: {e}")
