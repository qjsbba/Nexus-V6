...
class Moderation(commands.Cog):
    ...
    async def unlockall(self,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:hacker_tick:1271209580793167925> | Unlocking all channels in few seconds .")
    ...
    async def lockall(self, ctx, server: discord.Guild = None, *, reason=None):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:hacker_tick:1271209580793167925> | Locking all channels in few seconds .")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        await ctx.reply(embed=hacker)
        if server is None: server = ctx.guild
    ...
    async def give(
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if role not in member.roles:
                ...
                description=
                f"<:hacker_tick:1271209580793167925> | Changed roles for {member.name}, +{role.name}",
                color=0x2f3136)
    ...
    async def _hideall(self, ctx):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:hacker_tick:1271209580793167925> | Hiding all channels in few seconds .")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _unhideall(self, ctx):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:hacker_tick:1271209580793167925> | Unhiding all channels in few seconds .")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url =f"{ctx.author.avatar}")
        await ctx.reply(embed=hacker)
    ...
    async def _hide(self, ctx, channel: discord.TextChannel = None):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:hacker_tick:1271209580793167925> | Succefully Hidden {channel.mention} .")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _unhide(self, ctx, channel: discord.TextChannel = None):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:hacker_tick:1271209580793167925> | Succefully Unhidden {channel.mention} .")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
...
Reason: `{entry.reason}`\n\n''')
    ...
    async def _prefix(self, ctx: commands.Context, prefix):
      ...
      if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:         
          ...
          await ctx.reply(embed=discord.Embed(
            description=
            f"<:hacker_tick:1271209580793167925> | Successfully Changed Prefix For **{ctx.guild.name}**\nNew Prefix for **{ctx.guild.name}** is : `{prefix}`\nUse `{prefix}help` For More info .",
            color=0x2f3136))
      else:
          hacker5 = discord.Embed(
                description=
    ...
    async def purge(self, ctx, amount: int = 10):
        ...
        return await ctx.send(
            f"**<:hacker_tick:1271209580793167925> Deleted {len(deleted)-1} message(s)**"
        )
    ...
    async def startswith(self, ctx, key, amount: int = 10):
        ...
        return await ctx.send(
            f"**<:hacker_tick:1271209580793167925> Deleted {len(deleted)}/{amount} message(s) which started with the given keyword**"
        )
    ...
    async def endswith(self, ctx, key, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:hacker_tick:1271209580793167925> Deleted {len(deleted)}/{amount} message(s) which ended with the given keyword**"
        )
    ...
    async def contains(self, ctx, key, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:hacker_tick:1271209580793167925> Deleted {len(deleted)}/{amount} message(s) which contained the given keyword**"
        )
    ...
    async def user(self, ctx, user: discord.Member, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:hacker_tick:1271209580793167925> Deleted {len(deleted)}/{amount} message(s) which were sent by the mentioned user**"
        )
    ...
    async def invites(self, ctx, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:hacker_tick:1271209580793167925> Deleted {len(deleted)}/{amount} message(s) which contained invites**"
        )
    ...
    async def _mute(self, ctx, member: discord.Member, duration):
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            ...
            if tame == -1:
                ...
                color=0x2f3136,
                description=
                f"<:hacker_tick:1271209580793167925> | You didnt didnt gave time with correct unit\nExamples:\n{ctx.prefix}mute{ctx.author} 10m\n{ctx.prefix}mute {ctx.author} 5hr",
                ...
                color=0x2f3136,
                description=
                f"<:hacker_tick:1271209580793167925> | Time must be an integer!",
                timestamp=ctx.message.created_at)
                ...
                if till.lower() == "d":
                    ...
                    color=0x2f3136,
                    description=
                    "<:hacker_tick:1271209580793167925> | Successfully Muted {0.mention} For {1} Day(s)"
                    .format(member, ok))
                elif till.lower() == "m":
                    t = datetime.timedelta(seconds=tame)
                    hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:hacker_tick:1271209580793167925> | Successfully Muted {0.mention} For {1} Minute(s)"
                    .format(member, ok))
                    ...
                    color=0x2f3136,
                    description=
                    "<:hacker_tick:1271209580793167925> | Successfully Muted {0.mention} For {1} Second(s)"
                    .format(member, ok))
                    ...
                    color=0x2f3136,
                    description=
                    "<:hacker_tick:1271209580793167925> | Successfully Muted {0.mention} For {1} Hour(s)"
                    .format(member, ok))
            try:
                if member.guild_permissions.administrator:
                    ...
                    color=0x2f3136,
                    description=
                    "<:hacker_admin_cross:1271209737647558819> | I can\'t mute administrators")
            ...
            error = discord.Embed(
                        color=0x2f3136, description="""
<:hacker_admin_cross:1271209737647558819> You need certain Nexus Permissions to use this command!
       <:hacker_admin_cross:1271209737647558819> You need one of those permissions:
       `Timeout Command`
       """)
            error.set_author(
                 name="You can't use this command!",              icon_url=ctx.author.avatar.url
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            if member.is_timed_out():
                try:
                    ...
                    color=0x2f3136,
                    description=
                    f"<:hacker_tick:1271209580793167925> | Successfully Unmuted {member.name}")
                    await ctx.reply(embed=hacker5)
                except Exception as e:
                    hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:hacker_admin_cross:1271209737647558819> | Unable to Remove Timeout:\n```py\n{}```"
                    .format(e))
                    await ctx.send(embed=hacker)
            else:
                hacker1 = discord.Embed(
                color=0x2f3136,
                description="<:hacker_admin_cross:1271209737647558819> | {} Is Not Muted".
...
<:hacker_admin_cross:1271209737647558819> You need certain Nexus Permissions to use this command!
    ...
    @commands.hybrid_command(
        name="kick",
        aliases=['k'],
        help="Somebody is breaking rules simply kick him from the server as punishment",
        usage="kick <member>")
    @blacklist_check()
    @ignore_check()
    @iuser_check()
    ...
    async def _kick(self,
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            if member == self.bot:
                ...
                color=0x2f3136,
                description=
                f"<:hacker_tick:1271209580793167925> | {member.display_name} has been kicked from this guild, for: {reason}")
                    hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
                    await ctx.send(embed=hacker)
                    hacker1 = discord.Embed(
                color=0x2f3136,
                description=
                f"<:icons_exclamation:1144986614804787310> | You have been kicked from {ctx.guild.name} for: {reason} By [{ctx.author}](https://discord.com/users/{ctx.author.id})")
...
<:hacker_admin_cross:1271209737647558819> You need certain Nexus Permissions to use this command!
    ...
    async def _warn(self,ctx: commands.Context,member: discord.Member,*,reason=None):
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            ...
            color=0x2f3136,
            description=
            f"<:hacker_tick:1271209580793167925> | {member.display_name} has been warned for: {reason}")
            hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
            ...
            color=0x886ad1,
            description=
            f"<:icons_exclamation:1144986614804787310> | You have been warned in {ctx.guild.name} for: {reason} By [{ctx.author}](https://discord.com/users/{ctx.author.id})")
            await member.send(embed=hacker1)
        else:
            error = discord.Embed(
                        color=0x2f3136, description="""
    ...
    async def _ban(self,
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            if member == self.bot:
                ...
                color=0x00FFE4,
                description=
                f"<:hacker_tick:1271209580793167925> | {member.display_name} has been successfully banned")
                    hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
                ...
                color=0x00FFE4,
                description=
                f"<:icons_exclamation:1144986614804787310> | You have been banned from {ctx.message.guild.name} for reason: `{reason}` By [{ctx.author}](https://discord.com/users/{ctx.author.id})")
                    await member.send(embed=hacker1)
                except:
                    pass
        else:
...
<:hacker_admin_cross:1271209737647558819> You need certain Nexus Permissions to use this command!
    ...
    async def _unban(self, ctx: commands.Context, id: int):
        ...
        if ctx.author == ctx.guild.owner or str(ctx.author.id) in admin or adminrole in ctx.author.roles:
            ...
            color=0x2f3136,
            description=
            f"<:hacker_tick:1271209580793167925> | {user.name} has been successfully unbanned")
            hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
...
<:hacker_admin_cross:1271209737647558819> You need certain Nexus Permissions to use this command!
    ...
    async def clone(self, ctx: commands.Context, channel: discord.TextChannel):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:hacker_tick:1271209580793167925> | {channel.name} has been successfully cloned")
    ...
    async def changenickname(self, ctx: commands.Context,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:hacker_tick:1271209580793167925> | Successfully changed nickname of {member.name}")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _reactions(self, ctx, search=1000):
        ...
        await ctx.send(embed=discord.Embed(
            description=
            f"<:hacker_tick:1271209580793167925> | Successfully Removed {total_reactions}.",
            color=0x2f3136))
    ...
    async def _nuke(self,
        ...
        button = Button(label="Yes",
                        ...
                        emoji="<:hacker_tick:1271209580793167925>")
        button1 = Button(label="No",
                         style=discord.ButtonStyle.red,
                         emoji="<:hacker_admin_cross:1271209737647558819>")
    ...
    async def _lock(self,
        ...
        try:
            await channel.set_permissions(
                ...
                reason=reason)
            await ctx.send(embed=discord.Embed(
                title="Nexus | Lockdown",
                description=
                "<:hacker_tick:1271209580793167925> | Successfully locked **%s**"
                % (channel.mention),
                color=0x2f3136))
        except:
            await ctx.send(
                embed=discord.Embed(title="Nexus  | Lockdown",
    ...
    async def _unlock(self,
        ...
        try:
            await channel.set_permissions(
                ...
                reason=reason)
            await ctx.send(embed=discord.Embed(
                title="Nexus | Unlockdown",
                description=
                "<:hacker_tick:1271209580793167925> | Successfully unlocked **%s**"
                % (channel.mention),
                color=0x2f3136))
        except:
            await ctx.send(
                embed=discord.Embed(title="Nexus | Unlockdown",
...
**Description:** {pack.description}
    ...
    async def temp(self, ctx, role: discord.Role, time, *,
        ...
        if role == ctx.author.top_role:
            embed = discord.Embed(
                description=
                f"<:hacker_admin_cross:1271209737647558819> | {role} has the same position as your top role!",
                color=0x2f3136)
            ...
            if role.position >= ctx.guild.me.top_role.position:
                embed1 = discord.Embed(
                    description=
                    f"<:hacker_admin_cross:1271209737647558819> | {role} is higher than my role, move my role above {role}.",
                    color=0x2f3136)
        ...
        hacker = discord.Embed(
            description=
            f"<:hacker_tick:1271209580793167925> | Successfully added {role.mention} to {user.mention} .",
            color=0x2f3136)
        await ctx.send(embed=hacker)
    ...
    async def remove(self, ctx, user: discord.Member, role: discord.Role):
        ...
        hacker = discord.Embed(
            description=
            f"<:hacker_tick:1271209580793167925> | Successfully removed {role.mention} from {user.mention} .",
            color=0x2f3136)
        await ctx.send(embed=hacker)
    ...
    async def delete(self, ctx, role: discord.Role):
        ...
        if role is None:
            embed2 = discord.Embed(
                description=
                f"<:hacker_admin_cross:1271209737647558819> | No role named {role} found in this server .",
                color=0x2f3136)
            return await ctx.send(embed=embed2)
        await role.delete()
        hacker = discord.Embed(
            description=
            f"<:hacker_tick:1271209580793167925> | Successfully deleted {role}",
            color=0x2f3136)
        await ctx.send(embed=hacker)
    ...
    async def create(self, ctx, *, name):
        ...
        if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
            hacker = discord.Embed(
                description=
                f"<:hacker_tick:1271209580793167925> | Successfully created role with the name {name}",
                color=0x2f3136)
    ...
    async def rename(self, ctx, role: discord.Role, *, newname):
        ...
        if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
            ...
            await ctx.send(
                f"<:hacker_tick:1271209580793167925> | Role {role.name} has been renamed to {newname}"
            )
        elif role is None:
            embed2 = discord.Embed(
                description=
    ...
    async def humans(self,ctx,role:discord.Role):
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            hacker1 = discord.Embed(
                description=f"<:hacker_tick:1271209580793167925> | Added {role.mention} to all humans .",
                color=0x2f3136)
            ...
            for hacker in ctx.guild.members:
                if not hacker.bot:
                    try:
                        await hacker.add_roles(role,reason=f"Command Executed By {ctx.author}")
                    except:
                        pass
        else:
            hacker5 = discord.Embed(
    ...
    async def tokens(self,ctx,role:discord.Role):
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            hacker1 = discord.Embed(
                description=f"<:hacker_tick:1271209580793167925> | Added {role.mention} to all token members .",
                color=0x2f3136)
            hacker1.set_author(name=f"{ctx.author}",
                               icon_url=f"{ctx.author.avatar}")
    ...
    async def bots(self,ctx,role:discord.Role):
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            hacker1 = discord.Embed(
                description=f"<:hacker_tick:1271209580793167925> | Added {role.mention} to all bots .",
                color=0x2f3136)
            hacker1.set_author(name=f"{ctx.author}",
                               icon_url=f"{ctx.author.avatar}")
            for hacker in ctx.guild.members:
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(wled) == 15:
                hacker = discord.Embed(
                    title="Nexus",
                    description=
                    "<:icons_exclamation:1144986614804787310> You are trying to add more users than what it's allowed in [Trusted Admins]!",           color=0x2f3136)
                hacker.set_author(
                ...
                if str(user.id) in wled:
                    hacker1 = discord.Embed(
                        color=0x2f3136)
                    hacker1.add_field(
                    name="<:hacker_tick:1271209580793167925> Successful Operations",
                    value="No successful operation!",
                    inline=False)
                    hacker1.add_field(
                    name="<:icons_exclamation:1144986614804787310> Unsuccessful Operations",
                    value=f"""<:icons_exclamation:1144986614804787310> `{user}` <:hacker_tick:1271209580793167925>
                                                               <:hacker_admin_cross:1271209737647558819> *Already exists!*""",
                   inline=False)
                    hacker1.set_author(
                ...
                if ctx.author.avatar else ctx.author.default_avatar.url)
                    ...
                    hacker4.add_field(
                    name="<:hacker_tick:1271209580793167925> Successful Operations",
                    value=f"<:icons_exclamation:1144986614804787310> `{user}`",
                    inline=False)
                    hacker4.add_field(
                    name="<:hacker_admin_cross:1271209737647558819> Unsuccessful Operations",
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if str(user.id) in wled:
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    title="Nexus",
                    description=f"<:hacker_tick:1271209580793167925> | Successfully Removed {user.mention} From Admin list For {ctx.guild.name}"
                )
                await ctx.reply(embed=hacker, mention_author=False)
            else:
                hacker2 = discord.Embed(
                    ...
                    title="Nexus",
                    description=
                    "<:hacker_admin_cross:1271209737647558819> | That user is not in my admin list ."
                )
    ...
    async def admin_show(self, ctx):
        ...
        if len(wled) == 0:
            hacker = discord.Embed(
                ...
                title="Nexus",
                description=
                f"<:hacker_admin_cross:1271209737647558819> | There aren\'t any admin users for this server"
            )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            entries = [
    ...
    async def wl_reset(self, ctx: Context):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                ...
                title="Nexus",
                description=
                f"<:hacker_tick:1271209580793167925> | Successfully Cleared Admin Database For **{ctx.guild.name}**"
            )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            hacker5 = discord.Embed(
    ...
    async def whitelist_role(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker4 = discord.Embed(
                ...
                title="Nexus",
                description=
                f"<:hacker_tick:1271209580793167925> | {role.mention} Has Been Added To Admin Role For {ctx.guild.name}"
            )
            await ctx.reply(embed=hacker4, mention_author=False)
    ...
    @role.command(name="human")
    @commands.has_permissions(administrator=True)
    @blacklist_check()
    @ignore_check()
    @iuser_check()
    async def wwerrrwrwer(self,ctx,role:discord.Role):
        ''' Gives all the humans any role '''
        humans = [mem for mem in ctx.guild.members if not mem.bot]
        await ctx.send("<a:loadhearts:1144989282977710240> | Adding roles to all human")
        for h in humans:
            await h.add_roles(role)
        await ctx.reply('<:hacker_tick:1271209580793167925> | Added mentioned role to human')
    ...
    @ignore_check()
    @iuser_check()
    async def jujk(self,ctx,role:discord.Role):
        ''' Gives all any role '''
        all = [mem for mem in ctx.guild.members]
        await ctx.send("<a:loadhearts:1144989282977710240> | Adding roles to all")
        for h in all:
            await h.add_roles(role)
        await ctx.reply('<:tick:1076042204310679562> | Added mentioned role to all')

    @role.command(name="bot")
    @commands.has_permissions(administrator=True)
    @blacklist_check()
    @ignore_check()
    @iuser_check()
    async def lkj(self,ctx,role:discord.Role):
        ''' Give all bots any role '''
        humans = [mem for mem in ctx.guild.members if mem.bot]
        await ctx.send("<a:loadhearts:1144989282977710240> | Adding roles to all humans & bot")
        for h in humans:
            await h.add_roles(role)
        await ctx.reply('<:hacker_tick:1271209580793167925> | Added mentioned role to all bot')

    @_removerole.command(name="human")
    @commands.has_permissions(administrator=True)
    @blacklist_check()
    @ignore_check()
    @iuser_check()
    async def kljl(self,ctx,role:discord.Role):
        ...
        humans = [mem for mem in ctx.guild.members if not mem.bot]
        await ctx.send("<a:loadhearts:1144989282977710240> | Removing roles from all human")
        for h in humans:
            await h.remove_roles(role)
        await ctx.reply('<:hacker_tick:1271209580793167925> | Removed mentioned role from human')
    ...
    async def kjjk(self,ctx,role:discord.Role):
        ...
        await ctx.send("<a:loadhearts:1144989282977710240> | Removing roles from all")
        for h in humans:
            await h.remove_roles(role)
        await ctx.reply('<:hacker_tick:1271209580793167925> | Removed mentioned role from all')

    @_removerole.command(name="bot")
    @commands.has_permissions(administrator=True)
    @blacklist_check()
    @ignore_check()
    @iuser_check()
    async def lkklkl(self,ctx,role:discord.Role):
        ...
        humans = [mem for mem in ctx.guild.members if mem.bot]
        await ctx.send("<a:loadhearts:1144989282977710240> | Removing roles to all humans & bot")
        for h in humans:
            await h.remove_roles(role)
        await ctx.reply('<:hacker_tick:1271209580793167925> | Removed mentioned role from all bot')