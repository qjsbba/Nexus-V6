...
class Vanityroles(commands.Cog):
            ...
            if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
                if role.permissions.administrator or role.permissions.ban_members or role.permissions.kick_members:
                    embed1 = discord.Embed(
                        description=
                        "<:Nexus_cross:1144687282176147629> | Please Select Role That Dont Have Any Type Of Dangerous Permissions.",
                        color=0x2f3136)
                    ...
                    embed.add_field(
                        name="<:ArrowRight:1144695598734385153> Vanity",
                        value=f"{vanity}",
                        inline=False)
                    embed.add_field(
                        name="<:ArrowRight:1144695598734385153> Role",
                        value=f"{role.mention}",
                        inline=False)
                    embed.add_field(
                        name="<:ArrowRight:1144695598734385153> Channel",
                        value=f"{channel.mention}",
                        inline=False)
                    await ctx.send(embed=embed)
                    with open("db/vanityroles.json", "w") as f:
        ...
        with open("db/vanityroles.json", "r") as f:
            ...
            if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
                if str(ctx.guild.id) not in jnl:
                    embed1 = discord.Embed(
                        description=
                        "<:Nexus_cross:1144687282176147629> | This server don't have any vanity roles setupped yet .",
                        color=0x2f3136)
    ...
    async def config(self, ctx):
        ...
        if str(ctx.guild.id) not in jnl:
            ...
            embed.add_field(name="<:ArrowRight:1144695598734385153> Vanity",
                            value=f"{vanity}",
                            inline=False)
            embed.add_field(name="<:ArrowRight:1144695598734385153> Role",
                            value=f"{randirole.mention}",
                            inline=False)
            embed.add_field(name="<:ArrowRight:1144695598734385153> Channel",
